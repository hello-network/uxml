...
/**
 * Converts element types to TypeTokens for actionscript framework.
 *
 * @author ferhat
 *
 */
public final class As3FrameworkTypes {
  ...
  private static final String FRAMEWORK_NAMESPACE = "com.google.uxml";
  private static final String FRAMEWORK_GRAPHICS_NAMESPACE =
      "com.google.uxml.graphics";
  private static final String FRAMEWORK_EFFECTS_NAMESPACE =
      "com.google.uxml.effects";

  static {
    primitiveTypeNames.put(TypeToken.BOOLEAN, "Boolean");
    primitiveTypeNames.put(TypeToken.INT16, "int");
    primitiveTypeNames.put(TypeToken.UINT16, "uint");
    primitiveTypeNames.put(TypeToken.INT32, "int");
    primitiveTypeNames.put(TypeToken.UINT32, "uint");
    primitiveTypeNames.put(TypeToken.INT8, "int");
    primitiveTypeNames.put(TypeToken.UINT8, "uint");
    primitiveTypeNames.put(TypeToken.STRING, "String");
    primitiveTypeNames.put(TypeToken.DOUBLE, "Number");
    primitiveTypeNames.put(TypeToken.NUMBER, "Number");

    frameworkTokens.put("Application", new TypeToken(FRAMEWORK_NAMESPACE, "Application"));
  ...
  public static String tokenTypeToString(TypeToken type) {
    ...
    // If type is not primitive and namespace is in framework map, translate
    // to target type.
    if (name == null && type.getNamespace() != null && 
