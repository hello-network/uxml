 ...
 */
public class DartEnumSerializer implements CodeSerializer {
   ...
   * Constructor.
   */
  public DartEnumSerializer(Class<?> enumClass) {
  ...
  public Expression createExpression(String value, ModelCompiler compiler, CodeBlock codeBlock) {
    ...
    return new Reference(enumClass.getSimpleName() + "." + fieldName.toUpperCase());
  }
}
