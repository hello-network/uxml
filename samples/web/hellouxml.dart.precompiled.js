...
function dart_precompiled($collectedClasses) {
  ...
  InputElement.prototype.set$maxLength = function(receiver, v) {
    return receiver.maxLength = v;
  };
  ...
  TextAreaElement.prototype.set$maxLength = function(receiver, v) {
    return receiver.maxLength = v;
  };
  ...
  function LinkedHashMapCell(_collection$_key, _value, _next, _previous) {
  ...
  function MainPage(_host, _hostWidth, _hostHeight, _resources, _rootElement, _content, rootSurface, _scheduler, _mouseCaptureTarget, _modalElementStack, _modalLayoutHandler, _modalTint, _inputTs, _lastMouseMoveTime, _hasPendingMouseMove, _pendingEventDef, _pendingStageX, _pendingStageY, _pendingButtonDown, _pendingButton, _newMouseCursor, _newMouseSurface, _prevMouseSurface, _dragDropManager, _toolTips, _sharedMouseDownArgs, _sharedMouseArgs, _keyArgs, _mouseOverActiveList, _dragEnterList, listeners, _captureListeners, callingListenersDepth, hasGlobalListener, _propBag, parent, _bindings, id) {
    this._host = _host;
    this._hostWidth = _hostWidth;
    this._hostHeight = _hostHeight;
    this._resources = _resources;
    this._rootElement = _rootElement;
    this._content = _content;
    this.rootSurface = rootSurface;
    this._scheduler = _scheduler;
    this._mouseCaptureTarget = _mouseCaptureTarget;
    this._modalElementStack = _modalElementStack;
    this._modalLayoutHandler = _modalLayoutHandler;
    this._modalTint = _modalTint;
    this._inputTs = _inputTs;
    this._lastMouseMoveTime = _lastMouseMoveTime;
    this._hasPendingMouseMove = _hasPendingMouseMove;
    this._pendingEventDef = _pendingEventDef;
    this._pendingStageX = _pendingStageX;
    this._pendingStageY = _pendingStageY;
    this._pendingButtonDown = _pendingButtonDown;
    this._pendingButton = _pendingButton;
    this._newMouseCursor = _newMouseCursor;
    this._newMouseSurface = _newMouseSurface;
    this._prevMouseSurface = _prevMouseSurface;
    this._dragDropManager = _dragDropManager;
    this._toolTips = _toolTips;
    this._sharedMouseDownArgs = _sharedMouseDownArgs;
    this._sharedMouseArgs = _sharedMouseArgs;
    this._keyArgs = _keyArgs;
    this._mouseOverActiveList = _mouseOverActiveList;
    this._dragEnterList = _dragEnterList;
    this.listeners = listeners;
    this._captureListeners = _captureListeners;
    this.callingListenersDepth = callingListenersDepth;
    this.hasGlobalListener = hasGlobalListener;
    this._propBag = _propBag;
    this.parent = parent;
    this._bindings = _bindings;
    this.id = id;
  }
  MainPage.builtin$cls = "MainPage";
  if (!"name" in MainPage)
    MainPage.name = "MainPage";
  $desc = $collectedClasses.MainPage;
  if ($desc instanceof Array)
    $desc = $desc[1];
  MainPage.prototype = $desc;
  function Action() {
  }
  ...
  function ActiveActionList(_actionList, _valueList) {
    this._actionList = _actionList;
    this._valueList = _valueList;
  }
  ActiveActionList.builtin$cls = "ActiveActionList";
  if (!"name" in ActiveActionList)
    ActiveActionList.name = "ActiveActionList";
  $desc = $collectedClasses.ActiveActionList;
  if ($desc instanceof Array)
    $desc = $desc[1];
  ActiveActionList.prototype = $desc;
  function ActionValues(oldValue, newValue) {
    this.oldValue = oldValue;
    this.newValue = newValue;
  }
  ActionValues.builtin$cls = "ActionValues";
  if (!"name" in ActionValues)
    ActionValues.name = "ActionValues";
  $desc = $collectedClasses.ActionValues;
  if ($desc instanceof Array)
    $desc = $desc[1];
  ActionValues.prototype = $desc;
  function ActionData(startValue, targetElement, actionState, task, isUndefinedValue, tweener) {
    this.startValue = startValue;
    this.targetElement = targetElement;
    this.actionState = actionState;
    this.task = task;
    this.isUndefinedValue = isUndefinedValue;
    this.tweener = tweener;
  }
  ActionData.builtin$cls = "ActionData";
  if (!"name" in ActionData)
    ActionData.name = "ActionData";
  $desc = $collectedClasses.ActionData;
  if ($desc instanceof Array)
    $desc = $desc[1];
  ActionData.prototype = $desc;
  ActionData.prototype.get$startValue = function() {
    return this.startValue;
  };
  ActionData.prototype.get$actionState = function() {
    return this.actionState;
  };
  function AnimateAction(target, targetValue, property, fromValue, toValue, duration, delay, easing, startElement, completeCallback, reversible, dataMap) {
    this.target = target;
  ...
  AnimateAction.builtin$cls = "AnimateAction";
  if (!"name" in AnimateAction)
    AnimateAction.name = "AnimateAction";
  $desc = $collectedClasses.AnimateAction;
  if ($desc instanceof Array)
    $desc = $desc[1];
  AnimateAction.prototype = $desc;
  ...
  function AnimationScheduler(_tasks, _frameTimeStampValue, speedFactor) {
    this._tasks = _tasks;
    this._frameTimeStampValue = _frameTimeStampValue;
    this.speedFactor = speedFactor;
  }
  AnimationScheduler.builtin$cls = "AnimationScheduler";
  if (!"name" in AnimationScheduler)
    AnimationScheduler.name = "AnimationScheduler";
  $desc = $collectedClasses.AnimationScheduler;
  if ($desc instanceof Array)
    $desc = $desc[1];
  AnimationScheduler.prototype = $desc;
  ...
  BorderRadius.builtin$cls = "BorderRadius";
  if (!"name" in BorderRadius)
    BorderRadius.name = "BorderRadius";
  $desc = $collectedClasses.BorderRadius;
  if ($desc instanceof Array)
    $desc = $desc[1];
  BorderRadius.prototype = $desc;
  BorderRadius.prototype.get$topLeft = function(receiver) {
    return this.topLeft;
  };
  BorderRadius.prototype.get$topRight = function(receiver) {
    return this.topRight;
  };
  BorderRadius.prototype.get$bottomRight = function(receiver) {
    return this.bottomRight;
  };
  BorderRadius.prototype.get$bottomLeft = function(receiver) {
  ...
  function Canvas(sizeToContent, forceMeasureEmpty, childElements, _cachedPadding, chromeTree, _chromeDirty, _elementFlags, _hostSurface, app, measuredWidth, measuredHeight, layoutX, layoutY, layoutWidth, layoutHeight, _layoutFlags, _prevLayoutWidth, _prevLayoutHeight, _prevLayoutX, _prevLayoutY, _prevMeasureAvailableWidth, _prevMeasureAvailableHeight, _internalWidth, _internalHeight, _margins, _effects, _mask, sharedP, _resources, listeners, _captureListeners, callingListenersDepth, hasGlobalListener, _propBag, parent, _bindings, id) {
    this.sizeToContent = sizeToContent;
    this.forceMeasureEmpty = forceMeasureEmpty;
    this.childElements = childElements;
    this._cachedPadding = _cachedPadding;
    this.chromeTree = chromeTree;
    this._chromeDirty = _chromeDirty;
    this._elementFlags = _elementFlags;
    this._hostSurface = _hostSurface;
    this.app = app;
    ...
    this._layoutFlags = _layoutFlags;
    this._prevLayoutWidth = _prevLayoutWidth;
    this._prevLayoutHeight = _prevLayoutHeight;
    this._prevLayoutX = _prevLayoutX;
    this._prevLayoutY = _prevLayoutY;
    this._prevMeasureAvailableWidth = _prevMeasureAvailableWidth;
    this._prevMeasureAvailableHeight = _prevMeasureAvailableHeight;
    this._internalWidth = _internalWidth;
    this._internalHeight = _internalHeight;
  ...
  function CollectionChangedEvent(type, index, count, event, handled, source, currentSource, _forceDefault) {
    this.type = type;
    this.index = index;
    this.count = count;
    this.event = event;
    ...
    this._forceDefault = _forceDefault;
  }
  CollectionChangedEvent.builtin$cls = "CollectionChangedEvent";
  if (!"name" in CollectionChangedEvent)
    CollectionChangedEvent.name = "CollectionChangedEvent";
  $desc = $collectedClasses.CollectionChangedEvent;
  if ($desc instanceof Array)
    $desc = $desc[1];
  CollectionChangedEvent.prototype = $desc;
  function Color(color, _colorText) {
    this.color = color;
  ...
  ContentContainer.builtin$cls = "ContentContainer";
  if (!"name" in ContentContainer)
    ContentContainer.name = "ContentContainer";
  $desc = $collectedClasses.ContentContainer;
  if ($desc instanceof Array)
    $desc = $desc[1];
  ContentContainer.prototype = $desc;
  function Control(_cachedPadding) {
    this._cachedPadding = _cachedPadding;
  }
  Control.builtin$cls = "Control";
  if (!"name" in Control)
    Control.name = "Control";
  $desc = $collectedClasses.Control;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Control.prototype = $desc;
  Control.prototype.set$_cachedPadding = function(v) {
    return this._cachedPadding = v;
  };
  function Control_registerControl_closure() {
  }
  Control_registerControl_closure.builtin$cls = "Control_registerControl_closure";
  if (!"name" in Control_registerControl_closure)
    Control_registerControl_closure.name = "Control_registerControl_closure";
  $desc = $collectedClasses.Control_registerControl_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Control_registerControl_closure.prototype = $desc;
  function Coord(x, y) {
    this.x = x;
    this.y = y;
  }
  Coord.builtin$cls = "Coord";
  if (!"name" in Coord)
    Coord.name = "Coord";
  $desc = $collectedClasses.Coord;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Coord.prototype = $desc;
  Coord.prototype.get$x = function(receiver) {
    return this.x;
  };
  Coord.prototype.get$y = function(receiver) {
    return this.y;
  };
  ...
  Cursor.prototype.get$name = function(receiver) {
    return this.name;
  };
  function DataEvent() {
  }
  DataEvent.builtin$cls = "DataEvent";
  if (!"name" in DataEvent)
    DataEvent.name = "DataEvent";
  $desc = $collectedClasses.DataEvent;
  if ($desc instanceof Array)
    $desc = $desc[1];
  DataEvent.prototype = $desc;
  function DragDropManager(_dragActive, _sourceData, _sourceElement, _moveOverlay, _dragOffset, DRAG_DROP_OPACITY, mouseEventArgs) {
    this._dragActive = _dragActive;
    this._sourceData = _sourceData;
    this._sourceElement = _sourceElement;
    this._moveOverlay = _moveOverlay;
    this._dragOffset = _dragOffset;
    this.DRAG_DROP_OPACITY = DRAG_DROP_OPACITY;
    this.mouseEventArgs = mouseEventArgs;
  }
  DragDropManager.builtin$cls = "DragDropManager";
  if (!"name" in DragDropManager)
    DragDropManager.name = "DragDropManager";
  $desc = $collectedClasses.DragDropManager;
  if ($desc instanceof Array)
    $desc = $desc[1];
  DragDropManager.prototype = $desc;
  function Effect() {
  }
  Effect.builtin$cls = "Effect";
  if (!"name" in Effect)
    Effect.name = "Effect";
  $desc = $collectedClasses.Effect;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Effect.prototype = $desc;
  function ElementDef(name, parentDef, properties, _events) {
    this.name = name;
    this.parentDef = parentDef;
    this.properties = properties;
    this._events = _events;
  }
  ElementDef.builtin$cls = "ElementDef";
  if (!"name" in ElementDef)
    ElementDef.name = "ElementDef";
  $desc = $collectedClasses.ElementDef;
  if ($desc instanceof Array)
    $desc = $desc[1];
  ElementDef.prototype = $desc;
  ElementDef.prototype.get$name = function(receiver) {
    return this.name;
  };
  function PropertyDefinition(name, flags, dataType, _defaultValue, _ownerType, _changeCallback, _defaultOverrides, _callbackOverrides) {
    this.name = name;
    this.flags = flags;
    ...
    this._defaultOverrides = _defaultOverrides;
    this._callbackOverrides = _callbackOverrides;
  }
  PropertyDefinition.builtin$cls = "PropertyDefinition";
  if (!"name" in PropertyDefinition)
    PropertyDefinition.name = "PropertyDefinition";
  $desc = $collectedClasses.PropertyDefinition;
  if ($desc instanceof Array)
    $desc = $desc[1];
  PropertyDefinition.prototype = $desc;
  PropertyDefinition.prototype.get$name = function(receiver) {
    return this.name;
  };
  function EventDef(name, route, targetTypes, targetHandler) {
    this.name = name;
    this.route = route;
    this.targetTypes = targetTypes;
    this.targetHandler = targetHandler;
  }
  EventDef.builtin$cls = "EventDef";
  if (!"name" in EventDef)
    EventDef.name = "EventDef";
  $desc = $collectedClasses.EventDef;
  if ($desc instanceof Array)
    $desc = $desc[1];
  EventDef.prototype = $desc;
  EventDef.prototype.get$name = function(receiver) {
    return this.name;
  };
  function EventArgs(event, handled, source, currentSource, _forceDefault) {
    this.event = event;
    this.handled = handled;
    this.source = source;
    this.currentSource = currentSource;
  ...
  EventArgs.prototype.set$handled = function(v) {
    return this.handled = v;
  };
  EventArgs.prototype.get$source = function(receiver) {
    return this.source;
  };
  ...
  Filter.prototype.set$_owner = function(v) {
    return this._owner = v;
  };
  function Filters(_list, _innerShadow, _dropShadow, _owner) {
    this._list = _list;
    this._innerShadow = _innerShadow;
    this._dropShadow = _dropShadow;
    this._owner = _owner;
  }
  Filters.builtin$cls = "Filters";
  if (!"name" in Filters)
    Filters.name = "Filters";
  $desc = $collectedClasses.Filters;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Filters.prototype = $desc;
  Filters.prototype.get$_innerShadow = function() {
    return this._innerShadow;
  };
  Filters.prototype.get$_dropShadow = function() {
    return this._dropShadow;
  };
  function FocusEventArgs(_oldElement, _newElement, event, handled, source, currentSource, _forceDefault) {
    this._oldElement = _oldElement;
    this._newElement = _newElement;
    this.event = event;
    this.handled = handled;
    this.source = source;
    this.currentSource = currentSource;
  ...
  FocusEventArgs.builtin$cls = "FocusEventArgs";
  if (!"name" in FocusEventArgs)
    FocusEventArgs.name = "FocusEventArgs";
  $desc = $collectedClasses.FocusEventArgs;
  if ($desc instanceof Array)
    $desc = $desc[1];
  FocusEventArgs.prototype = $desc;
  function FocusManager(_focusHandler, _focusTarget, _focusOverlay, _focusEventArg, listeners, _captureListeners, callingListenersDepth, hasGlobalListener, _propBag, parent, _bindings, id) {
    this._focusHandler = _focusHandler;
    this._focusTarget = _focusTarget;
    this._focusOverlay = _focusOverlay;
    this._focusEventArg = _focusEventArg;
    this.listeners = listeners;
    this._captureListeners = _captureListeners;
    this.callingListenersDepth = callingListenersDepth;
    this.hasGlobalListener = hasGlobalListener;
  ...
  $desc = $collectedClasses.FocusManager;
  if ($desc instanceof Array)
    $desc = $desc[1];
  FocusManager.prototype = $desc;
  function FocusScopeData(_owner, tabStops) {
    this._owner = _owner;
    this.tabStops = tabStops;
  }
  FocusScopeData.builtin$cls = "FocusScopeData";
  if (!"name" in FocusScopeData)
    FocusScopeData.name = "FocusScopeData";
  $desc = $collectedClasses.FocusScopeData;
  if ($desc instanceof Array)
    $desc = $desc[1];
  FocusScopeData.prototype = $desc;
  function GlowFilter(_owner, listeners, _captureListeners, callingListenersDepth, hasGlobalListener, _propBag, parent, _bindings, id) {
    this._owner = _owner;
    this.listeners = listeners;
    this._captureListeners = _captureListeners;
    this.callingListenersDepth = callingListenersDepth;
  ...
  GlowFilter.builtin$cls = "GlowFilter";
  if (!"name" in GlowFilter)
    GlowFilter.name = "GlowFilter";
  $desc = $collectedClasses.GlowFilter;
  if ($desc instanceof Array)
    $desc = $desc[1];
  GlowFilter.prototype = $desc;
  function Group(childElements, _cachedPadding, chromeTree, _chromeDirty, _elementFlags, _hostSurface, app, measuredWidth, measuredHeight, layoutX, layoutY, layoutWidth, layoutHeight, _layoutFlags, _prevLayoutWidth, _prevLayoutHeight, _prevLayoutX, _prevLayoutY, _prevMeasureAvailableWidth, _prevMeasureAvailableHeight, _internalWidth, _internalHeight, _margins, _effects, _mask, sharedP, _resources, listeners, _captureListeners, callingListenersDepth, hasGlobalListener, _propBag, parent, _bindings, id) {
    this.childElements = childElements;
    this._cachedPadding = _cachedPadding;
    this.chromeTree = chromeTree;
    this._chromeDirty = _chromeDirty;
  ...
  Group.builtin$cls = "Group";
  if (!"name" in Group)
    Group.name = "Group";
  $desc = $collectedClasses.Group;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Group.prototype = $desc;
  function KeyboardEventArgs(_eventType, keyCode, charCode, event, handled, source, currentSource, _forceDefault) {
  ...
  KeyboardEventArgs.builtin$cls = "KeyboardEventArgs";
  if (!"name" in KeyboardEventArgs)
    KeyboardEventArgs.name = "KeyboardEventArgs";
  $desc = $collectedClasses.KeyboardEventArgs;
  if ($desc instanceof Array)
    $desc = $desc[1];
  KeyboardEventArgs.prototype = $desc;
  KeyboardEventArgs.prototype.get$keyCode = function(receiver) {
    return this.keyCode;
  };
  function Label(_cachedPadding, chromeTree, _chromeDirty, _elementFlags, _hostSurface, app, measuredWidth, measuredHeight, layoutX, layoutY, layoutWidth, layoutHeight, _layoutFlags, _prevLayoutWidth, _prevLayoutHeight, _prevLayoutX, _prevLayoutY, _prevMeasureAvailableWidth, _prevMeasureAvailableHeight, _internalWidth, _internalHeight, _margins, _effects, _mask, sharedP, _resources, listeners, _captureListeners, callingListenersDepth, hasGlobalListener, _propBag, parent, _bindings, id) {
    this._cachedPadding = _cachedPadding;
    this.chromeTree = chromeTree;
    this._chromeDirty = _chromeDirty;
    this._elementFlags = _elementFlags;
  ...
  Margin.builtin$cls = "Margin";
  if (!"name" in Margin)
    Margin.name = "Margin";
  $desc = $collectedClasses.Margin;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Margin.prototype = $desc;
  Margin.prototype.get$left = function(receiver) {
    return this.left;
  };
  Margin.prototype.get$top = function(receiver) {
    return this.top;
  };
  Margin.prototype.get$right = function(receiver) {
    return this.right;
  };
  Margin.prototype.get$bottom = function(receiver) {
    return this.bottom;
  };
  ...
  function Model(_children, _properties, _listeners, _isCallingListeners, _hasGlobalListener, _uxml$_name) {
    this._children = _children;
    this._properties = _properties;
    this._listeners = _listeners;
    this._isCallingListeners = _isCallingListeners;
    this._hasGlobalListener = _hasGlobalListener;
    this._uxml$_name = _uxml$_name;
  }
  ...
  function MouseEventArgs(_eventType, _button, posX, posY, deltaY, localPoint, event, handled, source, currentSource, _forceDefault) {
    this._eventType = _eventType;
  ...
  MouseEventArgs.builtin$cls = "MouseEventArgs";
  if (!"name" in MouseEventArgs)
    MouseEventArgs.name = "MouseEventArgs";
  $desc = $collectedClasses.MouseEventArgs;
  if ($desc instanceof Array)
    $desc = $desc[1];
  MouseEventArgs.prototype = $desc;
  MouseEventArgs.prototype.get$deltaY = function(receiver) {
    return this.deltaY;
  };
  function DragEventArgs(dragSource, data, _eventType, _button, posX, posY, deltaY, localPoint, event, handled, source, currentSource, _forceDefault) {
  ...
  DragEventArgs.builtin$cls = "DragEventArgs";
  if (!"name" in DragEventArgs)
    DragEventArgs.name = "DragEventArgs";
  $desc = $collectedClasses.DragEventArgs;
  if ($desc instanceof Array)
    $desc = $desc[1];
  DragEventArgs.prototype = $desc;
  function OverlayContainer(_host, _overlayMap, _overlayNeedsResize, _layoutWatchList, _cachedContent, _cachedPadding, chromeTree, _chromeDirty, _elementFlags, _hostSurface, app, measuredWidth, measuredHeight, layoutX, layoutY, layoutWidth, layoutHeight, _layoutFlags, _prevLayoutWidth, _prevLayoutHeight, _prevLayoutX, _prevLayoutY, _prevMeasureAvailableWidth, _prevMeasureAvailableHeight, _internalWidth, _internalHeight, _margins, _effects, _mask, sharedP, _resources, listeners, _captureListeners, callingListenersDepth, hasGlobalListener, _propBag, parent, _bindings, id) {
    this._host = _host;
    this._overlayMap = _overlayMap;
    this._overlayNeedsResize = _overlayNeedsResize;
    this._layoutWatchList = _layoutWatchList;
    this._cachedContent = _cachedContent;
    this._cachedPadding = _cachedPadding;
    this.chromeTree = chromeTree;
    this._chromeDirty = _chromeDirty;
    this._elementFlags = _elementFlags;
  ...
  OverlayContainer.builtin$cls = "OverlayContainer";
  if (!"name" in OverlayContainer)
    OverlayContainer.name = "OverlayContainer";
  $desc = $collectedClasses.OverlayContainer;
  if ($desc instanceof Array)
    $desc = $desc[1];
  OverlayContainer.prototype = $desc;
  function _OverlayList(targetElement, _overlays) {
    this.targetElement = targetElement;
    this._overlays = _overlays;
  }
  _OverlayList.builtin$cls = "_OverlayList";
  if (!"name" in _OverlayList)
    _OverlayList.name = "_OverlayList";
  $desc = $collectedClasses._OverlayList;
  if ($desc instanceof Array)
    $desc = $desc[1];
  _OverlayList.prototype = $desc;
  function _WatchList(viewNode, observers, sizeHandler, transformHandler, visibilityHandler) {
  ...
  _WatchList.prototype.get$observers = function() {
    return this.observers;
  };
  _WatchList.prototype.get$sizeHandler = function() {
  ...
  if (!"name" in Pen)
    Pen.name = "Pen";
  $desc = $collectedClasses.Pen;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Pen.prototype = $desc;
  function UIPlatform_scheduleEnterFrame_closure(app_0) {
    this.app_0 = app_0;
  }
  UIPlatform_scheduleEnterFrame_closure.builtin$cls = "UIPlatform_scheduleEnterFrame_closure";
  if (!"name" in UIPlatform_scheduleEnterFrame_closure)
    UIPlatform_scheduleEnterFrame_closure.name = "UIPlatform_scheduleEnterFrame_closure";
  $desc = $collectedClasses.UIPlatform_scheduleEnterFrame_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  UIPlatform_scheduleEnterFrame_closure.prototype = $desc;
  function UIPlatform_scheduleEnterFrame_closure0(animCallbackHandler_1) {
    this.animCallbackHandler_1 = animCallbackHandler_1;
  }
  UIPlatform_scheduleEnterFrame_closure0.builtin$cls = "UIPlatform_scheduleEnterFrame_closure0";
  if (!"name" in UIPlatform_scheduleEnterFrame_closure0)
    UIPlatform_scheduleEnterFrame_closure0.name = "UIPlatform_scheduleEnterFrame_closure0";
  $desc = $collectedClasses.UIPlatform_scheduleEnterFrame_closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  UIPlatform_scheduleEnterFrame_closure0.prototype = $desc;
  function UIPlatform_initializeAppEvents_closure(app_0) {
    this.app_0 = app_0;
  }
  UIPlatform_initializeAppEvents_closure.builtin$cls = "UIPlatform_initializeAppEvents_closure";
  if (!"name" in UIPlatform_initializeAppEvents_closure)
    UIPlatform_initializeAppEvents_closure.name = "UIPlatform_initializeAppEvents_closure";
  $desc = $collectedClasses.UIPlatform_initializeAppEvents_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  UIPlatform_initializeAppEvents_closure.prototype = $desc;
  function UIPlatform_initializeAppEvents_closure0(app_1) {
    this.app_1 = app_1;
  }
  UIPlatform_initializeAppEvents_closure0.builtin$cls = "UIPlatform_initializeAppEvents_closure0";
  if (!"name" in UIPlatform_initializeAppEvents_closure0)
    UIPlatform_initializeAppEvents_closure0.name = "UIPlatform_initializeAppEvents_closure0";
  $desc = $collectedClasses.UIPlatform_initializeAppEvents_closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  UIPlatform_initializeAppEvents_closure0.prototype = $desc;
  function UIPlatform_initializeAppEvents_closure1(app_2) {
    this.app_2 = app_2;
  }
  UIPlatform_initializeAppEvents_closure1.builtin$cls = "UIPlatform_initializeAppEvents_closure1";
  if (!"name" in UIPlatform_initializeAppEvents_closure1)
    UIPlatform_initializeAppEvents_closure1.name = "UIPlatform_initializeAppEvents_closure1";
  $desc = $collectedClasses.UIPlatform_initializeAppEvents_closure1;
  if ($desc instanceof Array)
    $desc = $desc[1];
  UIPlatform_initializeAppEvents_closure1.prototype = $desc;
  function UIPlatform_initializeAppEvents_closure2(app_3) {
    this.app_3 = app_3;
  }
  UIPlatform_initializeAppEvents_closure2.builtin$cls = "UIPlatform_initializeAppEvents_closure2";
  if (!"name" in UIPlatform_initializeAppEvents_closure2)
    UIPlatform_initializeAppEvents_closure2.name = "UIPlatform_initializeAppEvents_closure2";
  $desc = $collectedClasses.UIPlatform_initializeAppEvents_closure2;
  if ($desc instanceof Array)
    $desc = $desc[1];
  UIPlatform_initializeAppEvents_closure2.prototype = $desc;
  function UIPlatform_initializeAppEvents_closure3(app_4) {
    this.app_4 = app_4;
  }
  UIPlatform_initializeAppEvents_closure3.builtin$cls = "UIPlatform_initializeAppEvents_closure3";
  if (!"name" in UIPlatform_initializeAppEvents_closure3)
    UIPlatform_initializeAppEvents_closure3.name = "UIPlatform_initializeAppEvents_closure3";
  $desc = $collectedClasses.UIPlatform_initializeAppEvents_closure3;
  if ($desc instanceof Array)
    $desc = $desc[1];
  UIPlatform_initializeAppEvents_closure3.prototype = $desc;
  function UIPlatform_initializeAppEvents_closure4(app_5) {
    this.app_5 = app_5;
  }
  UIPlatform_initializeAppEvents_closure4.builtin$cls = "UIPlatform_initializeAppEvents_closure4";
  if (!"name" in UIPlatform_initializeAppEvents_closure4)
    UIPlatform_initializeAppEvents_closure4.name = "UIPlatform_initializeAppEvents_closure4";
  $desc = $collectedClasses.UIPlatform_initializeAppEvents_closure4;
  if ($desc instanceof Array)
    $desc = $desc[1];
  UIPlatform_initializeAppEvents_closure4.prototype = $desc;
  function UIPlatform_initializeAppEvents_closure5(app_6) {
    this.app_6 = app_6;
  }
  UIPlatform_initializeAppEvents_closure5.builtin$cls = "UIPlatform_initializeAppEvents_closure5";
  if (!"name" in UIPlatform_initializeAppEvents_closure5)
    UIPlatform_initializeAppEvents_closure5.name = "UIPlatform_initializeAppEvents_closure5";
  $desc = $collectedClasses.UIPlatform_initializeAppEvents_closure5;
  if ($desc instanceof Array)
    $desc = $desc[1];
  UIPlatform_initializeAppEvents_closure5.prototype = $desc;
  function UIPlatform_initializeAppEvents_closure6(app_7) {
    this.app_7 = app_7;
  }
  UIPlatform_initializeAppEvents_closure6.builtin$cls = "UIPlatform_initializeAppEvents_closure6";
  if (!"name" in UIPlatform_initializeAppEvents_closure6)
    UIPlatform_initializeAppEvents_closure6.name = "UIPlatform_initializeAppEvents_closure6";
  $desc = $collectedClasses.UIPlatform_initializeAppEvents_closure6;
  if ($desc instanceof Array)
    $desc = $desc[1];
  UIPlatform_initializeAppEvents_closure6.prototype = $desc;
  function UIPlatform_initializeAppEvents_closure7() {
  }
  UIPlatform_initializeAppEvents_closure7.builtin$cls = "UIPlatform_initializeAppEvents_closure7";
  if (!"name" in UIPlatform_initializeAppEvents_closure7)
    UIPlatform_initializeAppEvents_closure7.name = "UIPlatform_initializeAppEvents_closure7";
  $desc = $collectedClasses.UIPlatform_initializeAppEvents_closure7;
  if ($desc instanceof Array)
    $desc = $desc[1];
  UIPlatform_initializeAppEvents_closure7.prototype = $desc;
  function UIPlatform_initializeTouchEvents_closure(box_0, app_1) {
    this.box_0 = box_0;
    this.app_1 = app_1;
  }
  UIPlatform_initializeTouchEvents_closure.builtin$cls = "UIPlatform_initializeTouchEvents_closure";
  if (!"name" in UIPlatform_initializeTouchEvents_closure)
    UIPlatform_initializeTouchEvents_closure.name = "UIPlatform_initializeTouchEvents_closure";
  $desc = $collectedClasses.UIPlatform_initializeTouchEvents_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  UIPlatform_initializeTouchEvents_closure.prototype = $desc;
  function UIPlatform_initializeTouchEvents_closure0(box_0, app_2) {
    this.box_0 = box_0;
    this.app_2 = app_2;
  }
  UIPlatform_initializeTouchEvents_closure0.builtin$cls = "UIPlatform_initializeTouchEvents_closure0";
  if (!"name" in UIPlatform_initializeTouchEvents_closure0)
    UIPlatform_initializeTouchEvents_closure0.name = "UIPlatform_initializeTouchEvents_closure0";
  $desc = $collectedClasses.UIPlatform_initializeTouchEvents_closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  UIPlatform_initializeTouchEvents_closure0.prototype = $desc;
  function UIPlatform_initializeTouchEvents_closure1(box_0, app_3) {
    this.box_0 = box_0;
    this.app_3 = app_3;
  }
  UIPlatform_initializeTouchEvents_closure1.builtin$cls = "UIPlatform_initializeTouchEvents_closure1";
  if (!"name" in UIPlatform_initializeTouchEvents_closure1)
    UIPlatform_initializeTouchEvents_closure1.name = "UIPlatform_initializeTouchEvents_closure1";
  $desc = $collectedClasses.UIPlatform_initializeTouchEvents_closure1;
  if ($desc instanceof Array)
    $desc = $desc[1];
  UIPlatform_initializeTouchEvents_closure1.prototype = $desc;
  function RootSurface(app, body, rawChildren, _surfaceTarget, _hitTestMode, _painted, _visible, _opacity, _filterDist, _tag, renderTransform, parentSurface, root, hostElement, _canvas, _filters, _borderRadius, _backgroundBrush, mouseEnabled, _transform, layoutX, layoutY, layoutW, layoutH, locationInitialized, _frag, _clipChildren) {
    this.app = app;
    this.body = body;
    this.rawChildren = rawChildren;
    this._surfaceTarget = _surfaceTarget;
    this._hitTestMode = _hitTestMode;
    this._painted = _painted;
    this._visible = _visible;
    this._opacity = _opacity;
    this._filterDist = _filterDist;
    this._tag = _tag;
    ...
    this._backgroundBrush = _backgroundBrush;
    ...
    this._frag = _frag;
    this._clipChildren = _clipChildren;
  }
  RootSurface.builtin$cls = "RootSurface";
  if (!"name" in RootSurface)
    RootSurface.name = "RootSurface";
  $desc = $collectedClasses.RootSurface;
  if ($desc instanceof Array)
    $desc = $desc[1];
  RootSurface.prototype = $desc;
  function UISurfaceImpl(rawChildren, _surfaceTarget, _hitTestMode, _painted, _visible, _opacity, _filterDist, _tag, renderTransform, parentSurface, root, hostElement, _canvas, _filters, _borderRadius, _backgroundBrush, mouseEnabled, _transform, layoutX, layoutY, layoutW, layoutH, locationInitialized, _frag, _clipChildren) {
    this.rawChildren = rawChildren;
    this._surfaceTarget = _surfaceTarget;
    this._hitTestMode = _hitTestMode;
    this._painted = _painted;
  ...
  UISurfaceImpl.builtin$cls = "UISurfaceImpl";
  if (!"name" in UISurfaceImpl)
    UISurfaceImpl.name = "UISurfaceImpl";
  $desc = $collectedClasses.UISurfaceImpl;
  if ($desc instanceof Array)
    $desc = $desc[1];
  UISurfaceImpl.prototype = $desc;
  UISurfaceImpl.prototype.get$layoutX = function() {
    return this.layoutX;
  };
  UISurfaceImpl.prototype.get$layoutY = function() {
    return this.layoutY;
  };
  function UITextSurfaceImpl(_text, _fontName, _fontSize, _textColor, _fontBold, _divDirty, _wordWrap, measuredWidth, measuredHeight, maxChars, _isHtmlText, rawChildren, _surfaceTarget, _hitTestMode, _painted, _visible, _opacity, _filterDist, _tag, renderTransform, parentSurface, root, hostElement, _canvas, _filters, _borderRadius, _backgroundBrush, mouseEnabled, _transform, layoutX, layoutY, layoutW, layoutH, locationInitialized, _frag, _clipChildren) {
    this._text = _text;
    this._fontName = _fontName;
    this._fontSize = _fontSize;
    this._textColor = _textColor;
    this._fontBold = _fontBold;
    this._divDirty = _divDirty;
    this._wordWrap = _wordWrap;
    this.measuredWidth = measuredWidth;
    this.measuredHeight = measuredHeight;
    this.maxChars = maxChars;
    this._isHtmlText = _isHtmlText;
    this.rawChildren = rawChildren;
    this._surfaceTarget = _surfaceTarget;
    this._hitTestMode = _hitTestMode;
    this._painted = _painted;
  ...
  UITextSurfaceImpl.builtin$cls = "UITextSurfaceImpl";
  if (!"name" in UITextSurfaceImpl)
    UITextSurfaceImpl.name = "UITextSurfaceImpl";
  $desc = $collectedClasses.UITextSurfaceImpl;
  if ($desc instanceof Array)
    $desc = $desc[1];
  UITextSurfaceImpl.prototype = $desc;
  UITextSurfaceImpl.prototype.get$measuredWidth = function() {
    return this.measuredWidth;
  };
  UITextSurfaceImpl.prototype.get$measuredHeight = function() {
    return this.measuredHeight;
  };
  UITextSurfaceImpl.prototype.get$maxChars = function() {
    return this.maxChars;
  };
  UITextSurfaceImpl.prototype.set$maxChars = function(v) {
    return this.maxChars = v;
  };
  function TextMeasureUtils(hiddenTextElem, hiddenTextDivParent, hiddenTextDiv, _fontName, _fontSize, _fontBold, _argb, width, height, canvas, _fontKey, _fontSizeStr, _heightCache, _heightCacheBold) {
    this.hiddenTextElem = hiddenTextElem;
    this.hiddenTextDivParent = hiddenTextDivParent;
    this.hiddenTextDiv = hiddenTextDiv;
    this._fontName = _fontName;
    this._fontSize = _fontSize;
    this._fontBold = _fontBold;
    this._argb = _argb;
    ...
    this.height = height;
    this.canvas = canvas;
    this._fontKey = _fontKey;
    this._fontSizeStr = _fontSizeStr;
    this._heightCache = _heightCache;
    this._heightCacheBold = _heightCacheBold;
  }
  TextMeasureUtils.builtin$cls = "TextMeasureUtils";
  if (!"name" in TextMeasureUtils)
    TextMeasureUtils.name = "TextMeasureUtils";
  $desc = $collectedClasses.TextMeasureUtils;
  if ($desc instanceof Array)
    $desc = $desc[1];
  TextMeasureUtils.prototype = $desc;
  TextMeasureUtils.prototype.get$width = function(receiver) {
    return this.width;
  };
  TextMeasureUtils.prototype.set$width = function(receiver, v) {
    return this.width = v;
  };
  TextMeasureUtils.prototype.get$height = function(receiver) {
    return this.height;
  };
  TextMeasureUtils.prototype.set$height = function(receiver, v) {
    return this.height = v;
  };
  function Popup() {
  }
  Popup.builtin$cls = "Popup";
  if (!"name" in Popup)
    Popup.name = "Popup";
  $desc = $collectedClasses.Popup;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Popup.prototype = $desc;
  function PropertyCache_clearCache_closure(clsName_0, delList_1) {
    this.clsName_0 = clsName_0;
    this.delList_1 = delList_1;
  }
  PropertyCache_clearCache_closure.builtin$cls = "PropertyCache_clearCache_closure";
  if (!"name" in PropertyCache_clearCache_closure)
    PropertyCache_clearCache_closure.name = "PropertyCache_clearCache_closure";
  $desc = $collectedClasses.PropertyCache_clearCache_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  PropertyCache_clearCache_closure.prototype = $desc;
  function PropertyChangedEvent(property, oldValue, newValue, event, handled, source, currentSource, _forceDefault) {
    this.property = property;
    this.oldValue = oldValue;
    this.newValue = newValue;
    this.event = event;
  ...
  PropertyChangedEvent.builtin$cls = "PropertyChangedEvent";
  if (!"name" in PropertyChangedEvent)
    PropertyChangedEvent.name = "PropertyChangedEvent";
  $desc = $collectedClasses.PropertyChangedEvent;
  if ($desc instanceof Array)
    $desc = $desc[1];
  PropertyChangedEvent.prototype = $desc;
  PropertyChangedEvent.prototype.get$property = function() {
    return this.property;
  };
  PropertyChangedEvent.prototype.get$newValue = function(receiver) {
  ...
  function RectShape(_elementFlags, _hostSurface, app, measuredWidth, measuredHeight, layoutX, layoutY, layoutWidth, layoutHeight, _layoutFlags, _prevLayoutWidth, _prevLayoutHeight, _prevLayoutX, _prevLayoutY, _prevMeasureAvailableWidth, _prevMeasureAvailableHeight, _internalWidth, _internalHeight, _margins, _effects, _mask, sharedP, _resources, listeners, _captureListeners, callingListenersDepth, hasGlobalListener, _propBag, parent, _bindings, id) {
    this._elementFlags = _elementFlags;
    this._hostSurface = _hostSurface;
    this.app = app;
    this.measuredWidth = measuredWidth;
  ...
  RectShape.builtin$cls = "RectShape";
  if (!"name" in RectShape)
    RectShape.name = "RectShape";
  $desc = $collectedClasses.RectShape;
  if ($desc instanceof Array)
    $desc = $desc[1];
  RectShape.prototype = $desc;
  function Resources(_resources, _list) {
    this._resources = _resources;
    this._list = _list;
  }
  Resources.builtin$cls = "Resources";
  if (!"name" in Resources)
    Resources.name = "Resources";
  $desc = $collectedClasses.Resources;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Resources.prototype = $desc;
  function ScheduledTask(_startTime, _delay, _uxml$_duration, _callback, completionCallback, _uxml$_target, _tag, _currentTween, tweenStart, tweenEnd, _taskCompleted) {
    this._startTime = _startTime;
    this._delay = _delay;
    this._uxml$_duration = _uxml$_duration;
    this._callback = _callback;
    this.completionCallback = completionCallback;
    this._uxml$_target = _uxml$_target;
    this._tag = _tag;
    this._currentTween = _currentTween;
    this.tweenStart = tweenStart;
    this.tweenEnd = tweenEnd;
    this._taskCompleted = _taskCompleted;
  }
  ScheduledTask.builtin$cls = "ScheduledTask";
  if (!"name" in ScheduledTask)
    ScheduledTask.name = "ScheduledTask";
  $desc = $collectedClasses.ScheduledTask;
  if ($desc instanceof Array)
    $desc = $desc[1];
  ScheduledTask.prototype = $desc;
  ScheduledTask.prototype.get$_startTime = function() {
    return this._startTime;
  };
  ScheduledTask.prototype.get$_delay = function() {
    return this._delay;
  };
  ScheduledTask.prototype.get$_uxml$_duration = function() {
    return this._uxml$_duration;
  };
  ScheduledTask.prototype.get$completionCallback = function() {
    return this.completionCallback;
  };
  ScheduledTask.prototype.set$_currentTween = function(v) {
    return this._currentTween = v;
  };
  ScheduledTask.prototype.get$tweenStart = function() {
    return this.tweenStart;
  };
  ScheduledTask.prototype.get$tweenEnd = function() {
    return this.tweenEnd;
  };
  ScheduledTask.prototype.set$_taskCompleted = function(v) {
    return this._taskCompleted = v;
  };
  function Shape() {
  }
  ...
  function SolidPen(_color, _thickness) {
    this._color = _color;
    this._thickness = _thickness;
  }
  SolidPen.builtin$cls = "SolidPen";
  if (!"name" in SolidPen)
    SolidPen.name = "SolidPen";
  $desc = $collectedClasses.SolidPen;
  if ($desc instanceof Array)
    $desc = $desc[1];
  SolidPen.prototype = $desc;
  function _ToolTipManager(watchMap, watchList, timer, currentToolTip, previewListener) {
  ...
  _ToolTipManager.builtin$cls = "_ToolTipManager";
  if (!"name" in _ToolTipManager)
    _ToolTipManager.name = "_ToolTipManager";
  $desc = $collectedClasses._ToolTipManager;
  if ($desc instanceof Array)
    $desc = $desc[1];
  _ToolTipManager.prototype = $desc;
  function _ToolTipManager_mouseEnter_closure(this_0) {
    this.this_0 = this_0;
  }
  _ToolTipManager_mouseEnter_closure.builtin$cls = "_ToolTipManager_mouseEnter_closure";
  if (!"name" in _ToolTipManager_mouseEnter_closure)
    _ToolTipManager_mouseEnter_closure.name = "_ToolTipManager_mouseEnter_closure";
  $desc = $collectedClasses._ToolTipManager_mouseEnter_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  _ToolTipManager_mouseEnter_closure.prototype = $desc;
  function _ToolTipManager_mouseEnter__closure(this_1) {
    this.this_1 = this_1;
  }
  _ToolTipManager_mouseEnter__closure.builtin$cls = "_ToolTipManager_mouseEnter__closure";
  if (!"name" in _ToolTipManager_mouseEnter__closure)
    _ToolTipManager_mouseEnter__closure.name = "_ToolTipManager_mouseEnter__closure";
  $desc = $collectedClasses._ToolTipManager_mouseEnter__closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  _ToolTipManager_mouseEnter__closure.prototype = $desc;
  function _ToolTipManager__showTip_closure(this_0, element_1, tooltip_2, prevOpacity_3) {
    this.this_0 = this_0;
    this.element_1 = element_1;
    this.tooltip_2 = tooltip_2;
    this.prevOpacity_3 = prevOpacity_3;
  }
  _ToolTipManager__showTip_closure.builtin$cls = "_ToolTipManager__showTip_closure";
  if (!"name" in _ToolTipManager__showTip_closure)
    _ToolTipManager__showTip_closure.name = "_ToolTipManager__showTip_closure";
  $desc = $collectedClasses._ToolTipManager__showTip_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  _ToolTipManager__showTip_closure.prototype = $desc;
  function _ToolTipState(element, enterTime, moveTime, exitTime, waitTime, isInside, isOpen, mousePos, destroyListener, enterListener, moveListener, exitListener, tooltipMouseOverListener) {
    ...
    this.tooltipMouseOverListener = tooltipMouseOverListener;
  }
  _ToolTipState.builtin$cls = "_ToolTipState";
  if (!"name" in _ToolTipState)
    _ToolTipState.name = "_ToolTipState";
  $desc = $collectedClasses._ToolTipState;
  if ($desc instanceof Array)
    $desc = $desc[1];
  _ToolTipState.prototype = $desc;
  _ToolTipState.prototype.get$element = function() {
    return this.element;
  };
  _ToolTipState.prototype.set$enterTime = function(v) {
    return this.enterTime = v;
  };
  _ToolTipState.prototype.set$isInside = function(v) {
    return this.isInside = v;
  };
  _ToolTipState.prototype.get$isOpen = function() {
    return this.isOpen;
  };
  _ToolTipState.prototype.get$destroyListener = function() {
    return this.destroyListener;
  };
  function UIElement(_hostSurface, measuredWidth, measuredHeight, layoutX, layoutY, layoutWidth, layoutHeight, _layoutFlags, _margins, _mask) {
    this._hostSurface = _hostSurface;
    this.measuredWidth = measuredWidth;
    this.measuredHeight = measuredHeight;
    this.layoutX = layoutX;
  ...
  UIElement.builtin$cls = "UIElement";
  if (!"name" in UIElement)
    UIElement.name = "UIElement";
  $desc = $collectedClasses.UIElement;
  if ($desc instanceof Array)
    $desc = $desc[1];
  UIElement.prototype = $desc;
  UIElement.prototype.get$_hostSurface = function() {
    return this._hostSurface;
  };
  UIElement.prototype.get$measuredWidth = function() {
    return this.measuredWidth;
  };
  UIElement.prototype.get$measuredHeight = function() {
    return this.measuredHeight;
  };
  UIElement.prototype.get$layoutX = function() {
    return this.layoutX;
  };
  UIElement.prototype.get$layoutY = function() {
    return this.layoutY;
  };
  UIElement.prototype.get$layoutWidth = function() {
    return this.layoutWidth;
  };
  UIElement.prototype.get$layoutHeight = function() {
    return this.layoutHeight;
  };
  UIElement.prototype.get$_layoutFlags = function() {
    return this._layoutFlags;
  };
  UIElement.prototype.set$_margins = function(v) {
    return this._margins = v;
  };
  UIElement.prototype.set$_mask = function(v) {
    return this._mask = v;
  };
  function UIElement_scrollIntoView_closure(this_0) {
    this.this_0 = this_0;
  }
  UIElement_scrollIntoView_closure.builtin$cls = "UIElement_scrollIntoView_closure";
  if (!"name" in UIElement_scrollIntoView_closure)
    UIElement_scrollIntoView_closure.name = "UIElement_scrollIntoView_closure";
  $desc = $collectedClasses.UIElement_scrollIntoView_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  UIElement_scrollIntoView_closure.prototype = $desc;
  function UIElement_registerUIElement_closure() {
  }
  UIElement_registerUIElement_closure.builtin$cls = "UIElement_registerUIElement_closure";
  if (!"name" in UIElement_registerUIElement_closure)
    UIElement_registerUIElement_closure.name = "UIElement_registerUIElement_closure";
  $desc = $collectedClasses.UIElement_registerUIElement_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  UIElement_registerUIElement_closure.prototype = $desc;
  function UIElement_registerUIElement_closure0() {
  }
  UIElement_registerUIElement_closure0.builtin$cls = "UIElement_registerUIElement_closure0";
  if (!"name" in UIElement_registerUIElement_closure0)
    UIElement_registerUIElement_closure0.name = "UIElement_registerUIElement_closure0";
  $desc = $collectedClasses.UIElement_registerUIElement_closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  UIElement_registerUIElement_closure0.prototype = $desc;
  function UIElementContainer() {
  }
  UIElementContainer.builtin$cls = "UIElementContainer";
  if (!"name" in UIElementContainer)
    UIElementContainer.name = "UIElementContainer";
  $desc = $collectedClasses.UIElementContainer;
  if ($desc instanceof Array)
    $desc = $desc[1];
  UIElementContainer.prototype = $desc;
  function UISurface() {
  }
  UISurface.builtin$cls = "UISurface";
  if (!"name" in UISurface)
    UISurface.name = "UISurface";
  $desc = $collectedClasses.UISurface;
  if ($desc instanceof Array)
    $desc = $desc[1];
  UISurface.prototype = $desc;
  function UITransform(_targetElement, _transMatrix, listeners, _captureListeners, callingListenersDepth, hasGlobalListener, _propBag, parent, _bindings, id) {
    this._targetElement = _targetElement;
    this._transMatrix = _transMatrix;
    this.listeners = listeners;
    this._captureListeners = _captureListeners;
    this.callingListenersDepth = callingListenersDepth;
    this.hasGlobalListener = hasGlobalListener;
  ...
  UITransform.builtin$cls = "UITransform";
  if (!"name" in UITransform)
    UITransform.name = "UITransform";
  $desc = $collectedClasses.UITransform;
  if ($desc instanceof Array)
    $desc = $desc[1];
  UITransform.prototype = $desc;
  UITransform.prototype.set$_targetElement = function(v) {
    return this._targetElement = v;
  };
  function QueueCallbackData(_handler, _key, _data) {
    this._handler = _handler;
    this._key = _key;
    this._data = _data;
  }
  QueueCallbackData.builtin$cls = "QueueCallbackData";
  if (!"name" in QueueCallbackData)
    QueueCallbackData.name = "QueueCallbackData";
  $desc = $collectedClasses.QueueCallbackData;
  if ($desc instanceof Array)
    $desc = $desc[1];
  QueueCallbackData.prototype = $desc;
  QueueCallbackData.prototype.get$_key = function() {
    return this._key;
  };
  QueueCallbackData.prototype.get$_data = function() {
    return this._data;
  };
  function IKeyValue() {
  }
  IKeyValue.builtin$cls = "IKeyValue";
  if (!"name" in IKeyValue)
    IKeyValue.name = "IKeyValue";
  $desc = $collectedClasses.IKeyValue;
  if ($desc instanceof Array)
    $desc = $desc[1];
  IKeyValue.prototype = $desc;
  function UxmlElement(parent, id) {
    this.parent = parent;
    this.id = id;
  }
  UxmlElement.builtin$cls = "UxmlElement";
  if (!"name" in UxmlElement)
    UxmlElement.name = "UxmlElement";
  $desc = $collectedClasses.UxmlElement;
  if ($desc instanceof Array)
    $desc = $desc[1];
  UxmlElement.prototype = $desc;
  UxmlElement.prototype.get$parent = function(receiver) {
    return this.parent;
  };
  UxmlElement.prototype.set$parent = function(receiver, v) {
    return this.parent = v;
  };
  UxmlElement.prototype.get$id = function(receiver) {
    return this.id;
  };
